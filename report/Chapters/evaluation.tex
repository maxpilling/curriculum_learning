...
with no training of 15 and much lower than the score achieved after
training. Next, and in a more realistic situation, a network was trained on
MoveToBeacon for 2 hours and then on CollectMineralShards for 2 hours. This was
then compared to a network that was trained solely on the CollectMineralShards
mini-game for 4 hours. This then gave a score of 60 with transfer learning,
...
%TODO: Overall comparison over both Accuracy and Generalisation still needed.
