...
PySC2 and tensorflow also introduced some difficulties with developing the agents. Some of the runs gave internal errors from the tensorflow API. The usage of PySC2 required more research due to the poor documentation on the the API's implementation and feature system.