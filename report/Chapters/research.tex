...
learn much faster. Whilst interesting, this style of learning is not easily
compatible with the use of curriculum or transfer learning, which limits its
usefulness in this project, however it could be an interesting extension in the
future.
...
Finally, the last area that can be used for inspiration is the large amount of
work that has been done in the area of reinforcement learning throughout gaming,
rather than the work that is specific to StarCraft. Whilst older games such as
the aforementioned Atari 2600 games, differ heavily from StarCraft, there are
