...
are rarely given information in a random order, rather they are given it in a
...
examples, or as complicated as a full sequence of increasingly difficult
examples.
...
examples moves from a set of small easy examples and finishes with the full
...
domain, and can be experimented with as part of the final models evaluation.
