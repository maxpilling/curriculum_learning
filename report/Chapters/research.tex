...
where the earlier layers contain somewhat recognisable features, where the later
ones become more abstract, as shown in Figure~\ref{fig:filter_example}.
...
\subsection{Other required techniques}

% Maxpooling, Striding etc
